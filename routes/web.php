...
// Categories
Route::get('/manage-categories', [CategoriesController::class, 'categoryShow'])->middleware(['auth', 'verified'])->name('manage-categories');
...
Route::get('/manage-sub-categories', [CategoriesController::class, 'subCategoryShow'])->middleware(['auth', 'verified'])->name('manage-sub-categories');
Route::get('/category/new-sub-category', [CategoriesController::class, 'subCategoryCreate'])->middleware(['auth', 'verified'])->name('new-sub-category');
Route::post('/category/new-sub-category/store', [CategoriesController::class, 'subCategoryStore'])->middleware(['auth', 'verified'])->name('new-sub-category.store');
...
Route::get('/manage-sub-sub-categories', [CategoriesController::class, 'subSubCategoryShow'])->middleware(['auth', 'verified'])->name('manage-sub-sub-categories');
Route::get('/category/new-sub-sub-category', [CategoriesController::class, 'subSubCategoryCreate'])->middleware(['auth', 'verified'])->name('new-sub-sub-category');
Route::post('/category/new-sub-sub-category/store', [CategoriesController::class, 'subSubCategoryStore'])->middleware(['auth', 'verified'])->name('new-sub-sub-category.store');
