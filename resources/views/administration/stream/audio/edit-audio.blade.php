...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('manage-blogs') }}">Manage Audio's</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('audio.update', $blog->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="artist" value="{{ $blog->slug }}" placeholder="Artist" required />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="duration" value="{{ $blog->tags }}" placeholder="Duration" />
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="release_date" value="{{ $blog->header_title }}" placeholder="Release Date" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control" list="datalistSubcategory" name="subcategory_name" value="{{ $blog->subcategory_name }}" id="subcategory_name" placeholder="Sub Category" />
                    ...
                    <div class="col-sm-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control" list="datalistSubSubcategory" name="sub_subcategory_name" value="{{ $blog->sub_subcategory_name }}" placeholder="Sub Sub Category" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" list="datalistTemplate" name="book" value="{{ $blog->book }}" placeholder="Search Book" />
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" list="datalistAuthor" name="author" value="{{ $blog->author }}" placeholder="Search Author" required />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('blog/image/og/' . $blog->og) }}" class="img-thumbnail" alt="...">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="comment" rows="3">{{ $blog->comment }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
