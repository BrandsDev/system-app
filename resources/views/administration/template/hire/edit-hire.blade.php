...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Hire</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form class="needs-validation" method="POST" action="{{ route('template.hire.update', $hire->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $hire->name }}" placeholder="name" required />
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="email" value="{{ $hire->email }}" placeholder="Email" required />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="budget" id="below" value="below" autocomplete="off" @if($hire->budget == 'below') checked @endif />
                                <label class="btn btn-outline-primary btn-lg" for="below">Below $15,000</label>

                                <input type="radio" class="btn-check" name="budget" id="above" value="above" autocomplete="off" @if($hire->budget == 'above') checked @endif />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea id="custom-textarea" name="details">{{ $hire->details }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
