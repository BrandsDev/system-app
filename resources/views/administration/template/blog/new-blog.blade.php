...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('template.blog.manage-blog') }}">Manage Blogs</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('template.blog.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" list="datalistSeller" name="seller_name" placeholder="Search Seller" required />
                            <datalist id="datalistSeller">
