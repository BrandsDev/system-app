        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('template.new-page') }}">+ Add Page</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('template.page.view',$page->id) }}" class="btn btn-secondary">View</a>
                              <a href="{{ route('template.page.edit',$page->id) }}" class="btn btn-light">Edit</a>
                                ...
                                <div class="modal fade" id="deletepage{{ $page->id }}" tabindex="-1" aria-labelledby="deletepageLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('template.page.destroy',$page->id) }}">
                                        @csrf
                                        @method('DELETE')
