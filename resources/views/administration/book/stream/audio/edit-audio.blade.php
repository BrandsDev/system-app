...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-audios') }}">Manage Audios</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.audio.update', $audio->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
            ...
            <div class="col-sm-3">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/stream/audio/image/cover-image/' . $audio->cover_image) }}" class="img-thumbnail" alt="...">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <audio controls>
                                ...
                                <source src="{{ asset('book/stream/audio/' . $audio->audio_file) }}" type="audio/mpeg">
                            </audio>
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/stream/audio/image/og/' . $audio->og) }}" class="img-thumbnail" alt="...">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
