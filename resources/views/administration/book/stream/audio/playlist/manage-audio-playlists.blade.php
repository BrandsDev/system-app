        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-audio-playlist') }}">+ Add Audio Playlist</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('book.audio.edit',$audio->id) }}" class="btn btn-secondary">Edit</a>
                                ...
                                <div class="modal fade" id="deleteAudio{{ $audio->id }}" tabindex="-1" aria-labelledby="deleteAudioLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('book.audio.destroy',$audio->id) }}">
                                        @csrf
                                        @method('DELETE')
