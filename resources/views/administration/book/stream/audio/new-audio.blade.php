...
<main class="container p-3 py-5">
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.new-audio.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="duration" placeholder="Select Duration">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
