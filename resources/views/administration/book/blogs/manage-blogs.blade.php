        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-blog') }}">+ Add Blog</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('book/blog/image/featured/' . $blog->featured_image) }}" class="" alt="..." height="42" width="42" /></td>
                        <td>{{ $blog->title }}</td>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('book.blog.edit',$blog->id) }}" class="btn btn-secondary">Edit</a>
                                ...
                                <div class="modal fade" id="deleteBlog{{ $blog->id }}" tabindex="-1" aria-labelledby="deleteBlogLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('book.blog.destroy',$blog->id) }}">
                                        @csrf
                                        @method('DELETE')
