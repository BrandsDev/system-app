...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-blogs') }}">Manage Blogs</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.blog.update', $blog->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('book/blog/image/featured/' . $blog->featured_image) }}" class="img-thumbnail" alt="...">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('book/blog/image/og/' . $blog->og) }}" class="img-thumbnail" alt="...">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
