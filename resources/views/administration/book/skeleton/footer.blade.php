		<footer class="container">
			...
			<div class="row py-3 border border-start-0 border-top border-end-0">
				<div class="col-12">
					<nav class="nav">
						<a class="nav-link" href="{{ route('book.privacy-policy') }}">Privacy Policy</a>
						<a class="nav-link" href="{{ route('book.terms-of-service') }}">Terms of Service</a>
						<a class="nav-link" href="{{ route('book.license') }}">Licenses</a>
						<a class="nav-link" href="{{ route('book.contact-us') }}">Contact Us</a>
					</nav>
				</div>
			</div>
			<div class="row py-3">
