@extends('administration.book.skeleton.body') @section('custom-head')
        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-blog') }}">+ Add Book</a>
                </div>
            </div>
        </div>
    </div>
