...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-books') }}">Books</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.new-book.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
