...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-categories') }}">Categories</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-subcategories') }}">Subcategories</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('book.manage-sub-subcategories') }}">Sub Subcategories</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.sub-subcategory.update',$sub_subcategory->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3">{{ $sub_subcategory->description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/subcategory/sub-subcategory/icon/' . $sub_subcategory->icon) }}" class="img-thumbnail" height="85" width="85" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/subcategory/sub-subcategory/thumb/' . $sub_subcategory->thumb) }}" class="img-thumbnail" height="85" width="85" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/subcategory/sub-subcategory/cover/' . $sub_subcategory->cover) }}" class="img-thumbnail" height="630" width="630" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/subcategory/sub-subcategory/og/' . $sub_subcategory->og_image) }}" class="img-thumbnail" height="630" width="630" alt="...">
                        </div>
                        <div class="mb-3">
