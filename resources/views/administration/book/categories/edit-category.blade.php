...
<main class="container p-3 py-5">
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.category.update',$category->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
            ...
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/icon/' . $category->icon) }}" class="img-thumbnail" height="85" width="85" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/thumb/' . $category->thumb) }}" class="img-thumbnail" height="85" width="85" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/cover/' . $category->cover) }}" class="img-thumbnail" height="630" width="630" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <img src="{{ asset('book/category/og/' . $category->og_image) }}" class="img-thumbnail" height="630" width="630" alt="...">
                        </div>
                        <div class="mb-3">
