        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-category') }}">+ Add Category</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('book/category/icon/' . $category->icon) }}" class="" alt="..." height="42" width="42" /></td>
                        <td>{{ $category->category_name }}</td>
                        <td>{{ $category->slug }}</td>
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('book.category.edit',$category->id) }}" class="btn btn-secondary">Edit</a>
                                ...
                                <div class="modal fade" id="deleteCategories{{ $category->id }}" tabindex="-1" aria-labelledby="deleteCategoriesLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('book.category.destroy',$category->id) }}">
                                        @csrf
                                        @method('DELETE')
