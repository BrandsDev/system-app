        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-sub-subcategory') }}">+ Add Subcategory</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('book.sub-subcategory.edit',$category->id) }}" class="btn btn-secondary">Edit</a>
                                ...
                                <div class="modal fade" id="deleteSubSubcategories{{ $category->id }}" tabindex="-1" aria-labelledby="deleteSubSubcategoriesLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('book.sub-subcategory.destroy',$category->id) }}">
                                        @csrf
                                        @method('DELETE')
