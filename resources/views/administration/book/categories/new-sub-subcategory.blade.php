...
<main class="container p-3 py-5">
    ...
    <form class="needs-validation" method="POST" action="{{ route('book.new-sub-subcategory.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
            ...
            <div class="col-sm-3">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label for="og" class="form-label">Category OG *</label>
