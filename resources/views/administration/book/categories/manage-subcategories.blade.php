        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('book.new-subcategory') }}">+ Add Sub Category</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('book.subcategory.edit',$subcategory->id) }}" class="btn btn-secondary">Edit</a>
                                ...
                                <div class="modal fade" id="deleteSubcategory{{ $subcategory->id }}" tabindex="-1" aria-labelledby="deleteSubcategoryLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form method="POST" action="{{ route('book.subcategory.destroy',$subcategory->id) }}">
                                        @csrf
                                        @method('DELETE')
