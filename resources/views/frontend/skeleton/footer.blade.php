		<footer class="container">
			...
			<div class="row py-3 border border-start-0 border-end-0">
				<div class="col-md-8">
					...
					<p>By subscribing to our email list, you'll receive free <abbr title="HyperText Markup Language" class="initialism">HTML</abbr> website templates straight to your inbox! Don't miss out on the latest designs and updates - subscribe now to stay up to date and elevate your web development game.</p>
				</div>
