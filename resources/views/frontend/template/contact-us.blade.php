...
@section('content')
        ...
        <section>
			<div class="my-5 text-center">
				<img class="d-block mx-auto mb-2" src="{{ asset('template/boxed-logo.png') }}" alt="" width="72" height="57" />
				<h1>Contact Us</h1>
			...
			<div class="row">
				...
				<div class="col-md-4 col-lg-5 bg-white">
					<form class="row g-3 float-end needs-validation" method="POST" action="{{ route('template.front.new-contact') }}" novalidate>
						@csrf
						<div class="row g-3">
							<div class="col-sm-12">
