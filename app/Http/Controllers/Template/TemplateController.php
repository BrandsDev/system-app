...
class TemplateController extends Controller
{
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        if ($template) {
            ...
            $template->facebook_meta_title = $request->input('facebook_meta_title');
            $template->facebook_meta_description = $request->input('facebook_meta_description');
            $template->twitter_meta_title = $request->input('twitter_meta_title');
            $template->twitter_meta_description = $request->input('twitter_meta_description');
            $template->img_alt_text = $request->input('img_alt_text');
            $template->og_img_alt_text = $request->input('og_img_alt_text');
            $template->is_index = $request->input('is_index');
            $template->is_follow = $request->input('is_follow');
